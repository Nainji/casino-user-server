  ...
  try {
    ...
    await Market.findOne({
      ...
      if (market) {
        ...
        var superadminCommision = 0;
        var techadminCommision = 0;
        for (var k = 0; k < getUser.Parentcommission.length; k++) {
          if (market.eventTypeId == getUser.Parentcommission[k].sport_id) {
            ...
            superadminCommision = getUser.Parentcommission[k].superadmin;
            techadminCommision = getUser.Parentcommission[k].techadmin;
          }
        }
        ...
        if (market.marketType == 'SESSION') {
          ...
          Bet.find({
            ...
            if (newBalance < 0) {
              ...
              bet.superadmin = getUser.superadmin;
              bet.techadmin = getUser.techadmin;
              bet.managerId = getUser.managerId;
              bet.masterId = getUser.masterId;
              bet.subadminId = getUser.subadminId;
              bet.adminId = getUser.adminId;
              bet.superadminId = getUser.superadminId;
              bet.techadminId = getUser.techadminId;
              ...
              bet.superadminCommision = superadminCommision;
              bet.techadminCommision = techadminCommision;
